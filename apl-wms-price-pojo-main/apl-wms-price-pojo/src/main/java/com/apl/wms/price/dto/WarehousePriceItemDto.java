...
@Data
@ApiModel(value = "WarehousePriceItemDto传输对象", description = "项目价格")
@EqualsAndHashCode(callSuper = false)
public class WarehousePriceItemDto extends Model<WarehousePriceItemDto> {
    ...
    @Length(min = 1, max = 50, message = "模块长度不能超过30")
